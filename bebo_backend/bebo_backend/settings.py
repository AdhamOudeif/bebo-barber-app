"""
Django settings for bebo_backend project.
...
SECRET_KEY = 'django-insecure--k8h(nr2#w8y*l4%se8ji0!(l-i53^yc_sgd%ybznoejryr(yd'
...
ROOT_URLCONF = 'bebo_backend.urls'
...
WSGI_APPLICATION = 'bebo_backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'bebo_barber_db',          # Replace with your actual database name
